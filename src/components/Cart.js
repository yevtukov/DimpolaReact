...
import {headerHiddenPanelBasketVisibility} from "../utils/functions";
	...
	return (
			<div className="product-list__item">
				...
				<div className="product-list__price">
					<span className='amount_and_price'>{`${props.amount} x ${Number(props.price)} = ${props.amount * Number(props.price)}`}</span>
